...
function NotionBadge({ synced }: { synced: boolean }) {
  return synced ? (
    <span className="flex items-center gap-1 text-[0.625rem] text-green-600 bg-green-50 border border-green-200 px-1.5 py-0.5 rounded">
    ...
    <span className="text-[0.625rem] text-gray-400">Not synced</span>
  );
}
            ...
            <div key={note.topicId} className="rounded-xl border border-amber-100 bg-amber-50/40 overflow-hidden hover:border-amber-200 transition-colors">
              <div className="flex items-center gap-2 px-4 py-2.5 bg-amber-50 border-b border-amber-100">
                ...
                <div className="ml-auto flex items-center gap-2 flex-shrink-0">
                  ...
                  <span className="text-[0.625rem] text-gray-400">{timeAgo(note.updatedAt)}</span>
                </div>
              </div>
              ...
              <div className="px-4 py-2 border-t border-amber-100 flex items-center justify-between gap-2">
                <span className="text-[0.625rem] text-gray-400">{note.content.length} characters · Auto-saved</span>
                <div className="flex items-center gap-2">
                  <button
            ...
            return (
              <div key={key} className="rounded-xl border border-purple-100 bg-purple-50/30 overflow-hidden hover:border-purple-200 transition-colors">
                <div className="flex items-center gap-2 px-4 py-2.5 bg-purple-50 border-b border-purple-100">
                  ...
                  <div className="ml-auto flex items-center gap-2 flex-shrink-0">
                    <span className={`text-[0.625rem] font-semibold px-1.5 py-0.5 rounded border ${levelColor}`}>{s.level}</span>
                    <NotionBadge synced={s.syncedToNotion} />
                    <span className="text-[0.625rem] text-gray-400">{timeAgo(s.updatedAt)}</span>
                  </div>
                </div>
                <div className="px-4 py-3">
                ...
                <div className="px-4 py-2 border-t border-purple-100 flex items-center justify-between gap-2">
                  <span className="text-[0.625rem] text-gray-400">{s.format} format · AI generated</span>
                  <div className="flex items-center gap-2">
                    <button
