                  ...
                  <div className="mb-5">
                    ...
                    {summaryOpen && (
                      <div className="mt-3 rounded-xl border border-purple-200 bg-purple-50 dark:bg-purple-950/20 dark:border-purple-800 overflow-hidden">
                        <div className="flex items-center justify-between px-4 py-2.5 bg-purple-100 dark:bg-purple-900/30 border-b border-purple-200 dark:border-purple-800">
                            ...
                            <div className="space-y-2 animate-pulse">
                              {[90, 75, 85, 70, 80].map((w, i) => (
                                <div key={i} className="flex items-start gap-2">
                                  ...
                                  <div className={`h-3 bg-purple-200 rounded`} style={{ width: `${w}%` }} />
                                </div>
                              ))}
                            </div>
                          ) : (
                        ...
                        <div className="px-4 py-2 border-t border-purple-200 dark:border-purple-800">
                          <span className="text-[10px] text-purple-400">Generated by Claude AI · may not be 100% accurate</span>
                        </div>
                      </div>
                    )}
                  </div>
