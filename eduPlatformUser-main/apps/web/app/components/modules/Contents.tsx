                  ...
                  <div className="mb-5">
                    ...
                    {summaryOpen && (
                      <div className="mt-3 rounded-xl border border-purple-200 bg-purple-50 dark:bg-purple-950/20 dark:border-purple-800 overflow-hidden">
                        {/* Header: label + source note + format toggle + close */}
                        <div className="px-4 py-2.5 bg-purple-100 dark:bg-purple-900/30 border-b border-purple-200 dark:border-purple-800">
                          <div className="flex items-center justify-between">
